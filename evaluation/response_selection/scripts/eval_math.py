...
if __name__ == "__main__":
    ...
    argparse.add_argument("--j", type=str, default="/home/xxxx/_Code/Research_repo/tony_eval_folder_0811/0904_new_evaluation/refined_dataset/math-qwen2-72b-output.json", help="The file to read from")
