...
if __name__ == "__main__":
    ...
    argparse.add_argument("--j", type=str, default="/home/zxia545/_Code/Research_repo/tony_eval_folder_0811/0904_new_evaluation/refined_dataset/math-qwen2-72b-output.json", help="The file to read from")
    ...
    with open(f"../reference/math_reference.json", 'r') as f:
